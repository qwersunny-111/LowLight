...
parser.add_argument('--lowlight_images_path', type=str, default="/home/B_UserData/sunleyao/LowLight/train_data/train_data_2/")
parser.add_argument('--snapshots_folder', type=str, default="weight/")
parser.add_argument('--load_pretrain', type=bool, default=False)
# parser.add_argument('--pretrain_dir', type=str, default="weight/Epoch18.pth")
...
parser.add_argument('--test_dir', type=str, help='directory for testing output', default='/home/B_UserData/sunleyao/LowLight/test_data/test_output_ourtrain_20241029/')
parser.add_argument('--input_dir', type=str, help='directory for testing input', default='/home/B_UserData/sunleyao/LowLight/test_data/image20241029/')
